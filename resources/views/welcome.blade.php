...
<section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(/images/schoolview.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
			<h1 class="mb-4">Mairaj Khalid <br> Educational Complex</h1>
			<p>Own Adze, Own Way</p>
           
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Know More</a></p>
          </div>
        </div>
        </div>
      </div>

      <div class="slider-item" style="background-image:url(/images/kidsinlab.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
			<h1 class="mb-4">Serving since 1954</h1>
			<p>Education isn't a previlege. It's a right. </p>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Know More</a></p>
          </div>
        </div>
        </div>
    ...
    <section class="ftco-services ftco-no-pb">
          ...
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animat bg-white">
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
    	<div class="container">
          ...
          <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
            <h2 class="mb-4">Ikhwan High School Barki</h2>
            <p>Separated they live in. It is a paradisematic country. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(/images/schoolview.jpg);"
		data-stellar-background-ratio="0.8">
		<div class="container">
			<div class="row justify-content-center mb-5 pb-2 d-flex">
			
				<div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
					<h2 class="mb-4">Ikhwan Science College Barki</h2>
					<p>Separated they live in. It is a paradisematic country. It is a paradisematic country, in which
...
<section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>MKEC</span> Projects</h2>
            <p>Separated they live in. It is a paradisematic country</p>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(/images/course-1.jpg);"></di
						<div class="text pt-4">
							<p class="meta d-flex">
...
<section class="ftco-section bg-light">
			<div class="container-fluid px-4">
				<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Office Bearers.</h2>
            <p>MKEC has been previleged to be lead by the most experienced and acheived Leaders present in Education Sector. That has been a significant factor in persuating the vision that Mairaj Khalid (Late) once dreamt. </p>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background: grey;"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>Rana Muhammad Mansha</h3>
								<span class="position mb-2">President</span>
								<div class="faded">
									<p></p>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>Ch. Shafat Ahmad</h3>
								<span class="position mb-2">Senior Vice President</span>
								<div class="faded">
									<p></p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>Zahid Saleem</h3>
								<span class="position mb-2">Secretary General</span>
								<div class="faded">
									<p> </p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
